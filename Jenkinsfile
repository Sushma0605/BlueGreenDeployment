pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', credentialsId: 'git-cred', url: 'https://github.com/Sushma0605/Blue-Green-Deployment.git/3-Tier-NodeJS-MySql-Docker.git'
            }
        }
